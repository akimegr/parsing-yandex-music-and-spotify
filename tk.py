...
btnTag = Button(root,text="Получить треки, исполнителей и длительность из чарта YM ", bg = "black", fg="white", command = parseSoundAndName)
btnTag.place(x=70,y=50)
btnDate = Button(root, text="Просмотр существуюших лейблов", bg = "black", fg="white", command = checkLabeles )
btnDate.place(x=70, y = 80)
btnDiscription = Button(root, text  = "Просмотр артистов лейблов", bg = "black", fg = "white", command = allVoice)
btnDiscription.place(x=70, y = 110)
btnDiscription = Button(root, text  = "Анализ популярных жанров", bg = "black", fg = "white", command = checkgenre)
